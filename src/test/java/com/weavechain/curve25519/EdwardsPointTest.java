...
public class EdwardsPointTest {
    ...
    public void basepointDecompressionCompression() throws InvalidEncodingException {
        ...
        assertThat(B.compress(), Matchers.is(ED25519_BASEPOINT_COMPRESSED));
    }
    ...
    public void basepointSerializeDeserialize() throws IOException, ClassNotFoundException {
        ...
        assertThat(B, Matchers.is(Constants.ED25519_BASEPOINT));
    }
    ...
    public void decompressionSignHandling() throws InvalidEncodingException {
        ...
        assertThat(minusB.Y, Matchers.is(Constants.ED25519_BASEPOINT.Y));
        assertThat(minusB.Z, Matchers.is(Constants.ED25519_BASEPOINT.Z));
        assertThat(minusB.T, is(Constants.ED25519_BASEPOINT.T.negate()));
    }

    @Test
    public void ctSelectReturnsCorrectResult() {
        assertThat(Constants.ED25519_BASEPOINT.ctSelect(EdwardsPoint.IDENTITY, 0), Matchers.is(Constants.ED25519_BASEPOINT));
        assertThat(Constants.ED25519_BASEPOINT.ctSelect(EdwardsPoint.IDENTITY, 1), Matchers.is(EdwardsPoint.IDENTITY));
        assertThat(EdwardsPoint.IDENTITY.ctSelect(Constants.ED25519_BASEPOINT, 0), Matchers.is(EdwardsPoint.IDENTITY));
        assertThat(EdwardsPoint.IDENTITY.ctSelect(Constants.ED25519_BASEPOINT, 1), Matchers.is(Constants.ED25519_BASEPOINT));
    }
    ...
    public void basepointPlusBasepointVsBasepoint2Constant() {
        ...
        assertThat(B2.compress(), Matchers.is(BASE2_CMPRSSD));
    }
    ...
    public void basepointPlusBasepointProjectiveNielsVsBasepoint2Constant() {
        ...
        assertThat(B2.compress(), Matchers.is(EdwardsPointTest.BASE2_CMPRSSD));
    }
    ...
    public void scalarMulVsEd25519py() {
        ...
        assertThat(aB.compress(), Matchers.is(A_TIMES_BASEPOINT));
    }
    ...
    public void testVartimeDoubleScalarMultiplyBasepoint() throws InvalidEncodingException {
        ...
        // 0 * I + 0 * B = I
        assertThat(EdwardsPoint.vartimeDoubleScalarMultiplyBasepoint(zero, I, zero), Matchers.is(I));
        // 1 * I + 0 * B = I
        assertThat(EdwardsPoint.vartimeDoubleScalarMultiplyBasepoint(one, I, zero), Matchers.is(I));
        // 1 * I + 1 * B = B
        assertThat(EdwardsPoint.vartimeDoubleScalarMultiplyBasepoint(one, I, one), Matchers.is(B));
        // 1 * B + 1 * B = 2 * B
        ...
        // 0 * B + a * B = A
        assertThat(EdwardsPoint.vartimeDoubleScalarMultiplyBasepoint(zero, B, a), Matchers.is(A));
        // a * B + 0 * B = A
        assertThat(EdwardsPoint.vartimeDoubleScalarMultiplyBasepoint(a, B, zero), Matchers.is(A));
        // a * B + a * B = 2 * A
    ...
    public void doubleScalarMulBasepointVsEd25519py() throws InvalidEncodingException {
        ...
        assertThat(result.compress(), Matchers.is(DOUBLE_SCALAR_MULT_RESULT));
    }
    ...
    public void isTorsionFree() throws InvalidEncodingException {
        ...
        // result.
        assertThat(EdwardsPoint.IDENTITY.compress(), Matchers.is(EIGHT_TORSION_COMPRESSED[0]));

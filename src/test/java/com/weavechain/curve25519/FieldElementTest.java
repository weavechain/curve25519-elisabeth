...
public class FieldElementTest {
    ...
    public void testAMulAVsASquaredConstant() {
        ...
        assertThat(a.multiply(a), Matchers.is(asq));
    }
    ...
    public void testASquareVsASquaredConstant() {
        final FieldElement a = FieldElement.fromByteArray(A_BYTES);
        final FieldElement asq = FieldElement.fromByteArray(ASQ_BYTES);
        assertThat(a.square(), Matchers.is(asq));
    }
    ...
    public void testAInvertVsInverseOfAConstant() {
        ...
        assertThat(shouldBeInverse, Matchers.is(ainv));
        assertThat(a.multiply(shouldBeInverse), Matchers.is(FieldElement.ONE));
    }
    ...
    public void sqrtRatioM1Behavior() {
        ...
        assertThat(sqrt.result, Matchers.is(zero));
        ...
        assertThat(sqrt.wasSquare, is(1));
        assertThat(sqrt.result.square(), Matchers.is(four));
        assertThat(sqrt.result.isNegative(), is(0));

        // 1/4 is square, so we expect (1, 1/sqrt(4))
        sqrt = FieldElement.sqrtRatioM1(one, four);
        assertThat(sqrt.wasSquare, is(1));
        assertThat(sqrt.result.square().multiply(four), Matchers.is(one));
        assertThat(sqrt.result.isNegative(), is(0));
    }
    ...
    public void testAP58VsAP58Constant() {
        ...
        assertThat(a.powP58(), Matchers.is(ap58));
    }
    ...
    public void equality() {
        ...
        assertThat(a, is(Matchers.not(ainv)));
    }
    ...
    public void fromByteArrayHighbitIsIgnored() {
        ...
        assertThat(withoutHighbitSet, Matchers.is(withHighbitSet));
    }
    ...
    public void encodeAndDecodeOnZero() {
        ...
        assertThat(a, Matchers.is(FieldElement.ZERO));
    ...
    public void ctSelectReturnsCorrectResult() {
        ...
        assertThat(a.ctSelect(b, 0), Matchers.is(a));
        assertThat(a.ctSelect(b, 1), Matchers.is(b));
        assertThat(b.ctSelect(a, 0), Matchers.is(b));
        assertThat(b.ctSelect(a, 1), Matchers.is(a));
    }
}

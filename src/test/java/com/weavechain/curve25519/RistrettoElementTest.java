...
public class RistrettoElementTest {
    ...
    public void generatorDecompressionCompression() throws InvalidEncodingException {
        ...
        assertThat(B, Matchers.is(Constants.RISTRETTO_GENERATOR));
        assertThat(B.compress(), Matchers.is(RISTRETTO_GENERATOR_COMPRESSED));
    }
    ...
    public void generatorMultiplesAdd() throws InvalidEncodingException {
        ...
        for (int i = 0; i < GENERATOR_MULTIPLES.length; i++) {
            ...
            assertThat(P.compress(), Matchers.is(compressed));
            assertThat(compressed.decompress(), Matchers.is(P));
    ...
    public void generatorDblVsGenerator2() throws InvalidEncodingException {
        ...
        assertThat(Constants.RISTRETTO_GENERATOR.dbl(), Matchers.is(expected));
    }
    ...
    public void generatorTimesTwelveVsGenerator12() throws InvalidEncodingException {
        ...
        assertThat(Constants.RISTRETTO_GENERATOR.multiply(twelve), Matchers.is(expected));
    }
    ...
    public void fromUniformBytes() {
        ...
        for (int i = 0; i < FROM_UNIFORM_BYTES_INPUTS.length; i++) {
            ...
            assertThat(P.compress(), Matchers.is(new CompressedRistretto(Utils.hexToBytes(FROM_UNIFORM_BYTES_OUTPUTS[i]))));
        }
    }
}

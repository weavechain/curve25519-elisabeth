...
public class UnpackedScalarTest {
    ...
    public void unpackThenPack() {
        assertThat(UnpackedScalar.fromByteArray(ScalarTest.TV1_R).toByteArray(), Matchers.is(ScalarTest.TV1_R));
        assertThat(UnpackedScalar.fromByteArray(ScalarTest.TV1_H).toByteArray(), Matchers.is(ScalarTest.TV1_H));
        assertThat(UnpackedScalar.fromByteArray(ScalarTest.TV1_A).toByteArray(), Matchers.is(ScalarTest.TV1_A));
        assertThat(UnpackedScalar.fromByteArray(ScalarTest.TV1_S).toByteArray(), Matchers.is(ScalarTest.TV1_S));
    }

    @Test
    public void addLToZero() {
        assertThat(UnpackedScalar.ZERO.add(Constants.L).s, Matchers.is(UnpackedScalar.ZERO.s));
    }

    @Test
    public void add() {
        assertThat(A.add(B).s, Matchers.is(UnpackedScalar.ZERO.s));
    }

    @Test
    public void subtract() {
        assertThat(A.subtract(B).s, Matchers.is(AB.s));
    }

    @Test
    public void multiply() {
        assertThat(X.multiply(Y).s, Matchers.is(XY.s));
    }

    @Test
    public void multiplyMax() {
        assertThat(X.multiply(X).s, Matchers.is(XX.s));
    }
}
